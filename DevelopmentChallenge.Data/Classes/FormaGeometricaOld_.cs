...
{
    public class FormaGeometricaOld_
    {
        #region Formas
        ...
        public FormaGeometricaOld_(int tipo, decimal ancho)
        {
            Tipo = tipo;
            _lado = ancho;
        }

        public static string Imprimir(List<FormaGeometricaOld_> formas, int idioma)
        {
